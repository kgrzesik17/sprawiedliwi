...
<p>
    <img src="{{ asset('images/17289918505351512737.jpg') }}" alt="obraz">
</p>
...
<p>
    <strong>W skład odznaczenia wchodzi dyplom honorowy, medal , statuetka.</strong>
</p>

<p>
    <img src="{{ asset('images/sprawiedliwi-odznaczenie.png') }}" alt="obraz">
</p>

<p>
    <strong>Kto może otrzymać.</strong>
</p>
...
<p>
    <strong>Jeśli osoba ta nie żyje, jej krewny może wystąpić o przyznanie jej tytułu Sprawiedliwego Wśród Ukraińców.</strong>
</p>
